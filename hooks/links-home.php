<?php
	...
	/* http://localhost/demo/orders_view.php?SortField=&SortDirection=&FilterAnd%5B1%5D=&FilterField%5B1%5D=6&FilterOperator%5B1%5D=is-empty&FilterValue%5B1%5D= */
		...
		// );
			...
			$homeLinks[] = array(
			'url' => 'http://18.228.11.172:8501/" target="_blank',
			'title' => 'DASHBOARD', 
		...
		$homeLinks[] = array(
			'url' => 'https://datastudio.google.com/reporting/1054b5e0-7f04-4e24-8a01-a7c544120ab5" target="_blank',
			'title' => 'Informes PQR x Periodo - SAC',
			'groups' => array('Admins','SSM'), // groups allowed to see this link, use '*' if you want to show the link to all groups
			'table_group' => 'Parametros',
			'description' => '',
			'grid_column_classes' => 'col-md-1 col-lg-12',
			'panel_classes' => '',
			'link_classes' => '',
		...
		$homeLinks[] = array(
			'url' => 'https://datastudio.google.com/u/0/reporting/8431a726-55c7-4e7b-96ec-53f2ee9c920b/page/tclcC" target="_blank',
			'title' => 'Otros Tramites - SAC',
			'groups' => array('Admins','SSM'), // groups allowed to see this link, use '*' if you want to show the link to all groups
			'table_group' => 'Parametros',
			'description' => '',
			'grid_column_classes' => 'col-md-1 col-lg-12',
			...
			$homeLinks[] = array(
			'url' => 'https://datastudio.google.com/reporting/d3774fe1-4ae0-42df-8702-2f57fd7635f5" target="_blank',
