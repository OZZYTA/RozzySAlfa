	...
	function get_tables_info($skip_authentication = false) {
		...
		$all_tables = array(
			/* ['table_name' => [table props assoc array] */   
				'pqr' => array(
					'Caption' => 'PQR',
					'Description' => 'Radique, Consulte y verifique el estado de las PQR',
				...
				'Encuesta' => array(
					...
					'Description' => 'Responda una breve encuesta de satisfacci&#243;n para determinar su nivel de satisfacci&#243;n con su EPS',
					'tableIcon' => 'resources/table_icons/statistics.png',
					'group' => $tg[2],
					'homepageShowCount' => 0
				),
				'barrios' => array(
					'Caption' => 'Barrios',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/home_page.png',
					'group' => $tg[3],
					'homepageShowCount' => 0
				),
				'soportes' => array(
					'Caption' => 'Soportes',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/file_extension_dat.png',
					'group' => $tg[3],
					'homepageShowCount' => 0
				),
				'eps' => array(
				...
				'motivos' => array(
					'Caption' => 'Motivos',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/color_adjustment.png',
					'group' => $tg[3],
					'homepageShowCount' => 0
				),
				'obmotivos' => array(
					'Caption' => 'Observaciones a Motivo',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/google_custom_search.png',
					'group' => $tg[3],
					'homepageShowCount' => 0
				),
				'cie10' => array(
					'Caption' => 'CIE10',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/pill_go.png',
					'group' => $tg[3],
					'homepageShowCount' => 0
				),
				'ips' => array(
				...
				'mails' => array(
					'Caption' => 'Correos Enviados',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/documents_email.png',
					'group' => $tg[3],
					'homepageShowCount' => 0
				),
				'covid' => array(
					'Caption' => 'Encuesta 521',
					'Description' => 'Encuesta para evaluaci&#243;n del comportamiento de las EPS en cuanto a la atenci&#243;n brindada a los pacientes pertencientes a los 4 grupos poblaci&#243;n de control segun la Resolucion 521 en su numeral 4, durante el Periodo de Aislamiento preventivo obligatorio.',
				...
				'regimenes' => array(
					'Caption' => 'Regimenes',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/shape_ungroup.png',
					'group' => $tg[3],
					'homepageShowCount' => 0
				),
				'otros' => array(
					'Caption' => 'Otros Tramites - SAC SSM',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/motherboard.png',
					'group' => $tg[1],
					'homepageShowCount' => 0
				),
				'prass' => array(
					'Caption' => 'Seguimiento PRASS',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/vcard_add.png',
					'group' => $tg[2],
					'homepageShowCount' => 0
				),
				'oportunidad' => array(
					'Caption' => 'Oportunidad',
					'Description' => 'Encuesta para verificaci&#243;n de oportunidad en atenci&#243;n',
					'tableIcon' => 'resources/table_icons/time.png',
					'group' => $tg[2],
					'homepageShowCount' => 0
				),
		);
	...
	if(!function_exists('getTableList')) {
		function getTableList($skip_authentication = false) {
			$arrTables = array(
				...
				'eps' => 'Entidades',
				'motivos' => 'Motivos',
				'obmotivos' => 'Observaciones a Motivo',
				'cie10' => 'CIE10',
				'ips' => 'IPS',
				'mails' => 'Correos Enviados',
				'covid' => 'Encuesta 521',
				'regimenes' => 'Regimenes',
				'otros' => 'Otros Tramites - SAC SSM',
				'prass' => 'Seguimiento PRASS',
...
########################################################################
		...
		if($schema === null) {
			...
			$schema = [
				'pqr' => [
					...
					'consecutivo' => ['appgini' => "INT NULL UNIQUE"],
					'oficio' => ['appgini' => "VARCHAR(18) NULL"],
					'fecha' => ['appgini' => "DATE NULL"],
					'tipoid' => ['appgini' => "VARCHAR(5) NOT NULL"],
					'procedencia' => ['appgini' => "VARCHAR(40) NULL"],
					'doc' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'nombres' => ['appgini' => "CHAR(60) NOT NULL"],
					'apellidos' => ['appgini' => "CHAR(60) NOT NULL"],
					'genero' => ['appgini' => "VARCHAR(5) NOT NULL"],
					'nacimiento' => ['appgini' => "DATE NOT NULL"],
					'edad' => ['appgini' => "INT(3) NULL"],
					'direccion' => ['appgini' => "VARCHAR(100) NOT NULL"],
					'barrio' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'comuna' => ['appgini' => "VARCHAR(40) NULL"],
					'telefono' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'notel' => ['appgini' => "VARCHAR(40) NULL"],
					'correo' => ['appgini' => "VARCHAR(100) NOT NULL"],
					'nocorreo' => ['appgini' => "VARCHAR(40) NULL"],
					'sac' => ['appgini' => "VARCHAR(2) NULL"],
					'tipopqr' => ['appgini' => "VARCHAR(20) NOT NULL"],
					'poblacion' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'regimen' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'eps' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'otraeps' => ['appgini' => "VARCHAR(40) NULL"],
					'gerente' => ['appgini' => "VARCHAR(40) NULL"],
					'teleps' => ['appgini' => "VARCHAR(40) NULL"],
					'maileps' => ['appgini' => "VARCHAR(40) NULL"],
					'cc2' => ['appgini' => "VARCHAR(40) NULL"],
					'cc3' => ['appgini' => "VARCHAR(40) NULL"],
					'acudiente' => ['appgini' => "VARCHAR(40) NULL"],
					'nombreacu' => ['appgini' => "VARCHAR(40) NULL"],
					'docacudiente' => ['appgini' => "BIGINT NULL"],
					'ref' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'motivo' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'obmotivo' => ['appgini' => "VARCHAR(100) NOT NULL"],
					'fechainc' => ['appgini' => "DATE NOT NULL"],
					'servicio' => ['appgini' => "VARCHAR(100) NOT NULL"],
					'enfermedad' => ['appgini' => "VARCHAR(10) NOT NULL"],
					'descripcie10' => ['appgini' => "VARCHAR(10) NULL"],
					'descripcion' => ['appgini' => "TEXT NOT NULL"],
					'estado' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'condicion' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'cierre' => ['appgini' => "DATE NULL"],
					'conclusion' => ['appgini' => "TEXT NULL"],
					'dias' => ['appgini' => "VARCHAR(40) NULL"],
					'diascierre' => ['appgini' => "VARCHAR(40) NULL"],
					'indicador' => ['appgini' => "VARCHAR(40) NULL"],
					'detalle1' => ['appgini' => "TEXT NULL"],
					'fecha1' => ['appgini' => "VARCHAR(40) NULL"],
					'detalle2' => ['appgini' => "TEXT NULL"],
					'fecha2' => ['appgini' => "VARCHAR(40) NULL"],
					'detalle3' => ['appgini' => "TEXT NULL"],
					'fecha3' => ['appgini' => "VARCHAR(40) NULL"],
					'detalle4' => ['appgini' => "TEXT NULL"],
					'fallecido' => ['appgini' => "VARCHAR(40) NULL"],
					'status' => ['appgini' => "VARCHAR(40) NULL"],
					'periodo' => ['appgini' => "VARCHAR(40) NULL"],
					'asignado' => ['appgini' => "VARCHAR(40) NULL"],
					'ingresada' => ['appgini' => "VARCHAR(40) NULL DEFAULT '1'"],
					'cargada' => ['appgini' => "VARCHAR(40) NULL"],
					'emailuser' => ['appgini' => "VARCHAR(40) NULL"],
					'observaciones' => ['appgini' => "VARCHAR(255) NULL"],
				],
				'Encuesta' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'fecha' => ['appgini' => "DATE NULL"],
					'tipoid' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'doc' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'nombres' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'apellidos' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'eps' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'ipsprim' => ['appgini' => "VARCHAR(100) NULL"],
					'tratoser' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'cita' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'tratoasis' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'expprof' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'bioser' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'area' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'pyp' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'prenatal' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'cyd' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'vacunas' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'pfm' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'citologia' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'sservicio' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'incomodo' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'otro' => ['appgini' => "VARCHAR(40) NULL"],
					'why' => ['appgini' => "TEXT NULL"],
					'urgencia' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'citaoportuna' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'aspectoeps' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'fisicas' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'aseo' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'capacitacion' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'autorizaciones' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'general' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'horario' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'formulario' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'farmacia' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'fisicasfarma' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'oporfarmacia' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'totalidad' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'cambio' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'volver' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'orientacion' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'embalaje' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'revision' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'observaciones' => ['appgini' => "TEXT NULL"],
					'user' => ['appgini' => "VARCHAR(40) NULL"],
				],
				'barrios' => [
					'nombre' => ['appgini' => "VARCHAR(40) NOT NULL PRIMARY KEY"],
					'comuna' => ['appgini' => "VARCHAR(40) NOT NULL"],
				],
				'soportes' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'doc' => ['appgini' => "INT UNSIGNED NULL"],
					'soporte1' => ['appgini' => "VARCHAR(40) NULL"],
					'soporte2' => ['appgini' => "VARCHAR(40) NULL"],
					'soporte3' => ['appgini' => "VARCHAR(40) NULL"],
					'soporte4' => ['appgini' => "VARCHAR(40) NULL"],
				],
				'eps' => [
					'razonsocial' => ['appgini' => "VARCHAR(40) NOT NULL PRIMARY KEY"],
					'regimen' => ['appgini' => "VARCHAR(40) NULL"],
					'gerente' => ['appgini' => "VARCHAR(40) NULL"],
					'telefono' => ['appgini' => "VARCHAR(40) NULL"],
					'correo' => ['appgini' => "VARCHAR(200) NULL"],
					'correo2' => ['appgini' => "VARCHAR(100) NULL"],
					'correo3' => ['appgini' => "VARCHAR(100) NULL"],
				],
				'motivos' => [
					'motivo' => ['appgini' => "VARCHAR(40) NOT NULL PRIMARY KEY"],
				],
				'obmotivos' => [
					'motivo' => ['appgini' => "VARCHAR(40) NULL"],
					'observacion' => ['appgini' => "VARCHAR(100) NOT NULL PRIMARY KEY"],
				],
				'cie10' => [
					'cie10' => ['appgini' => "VARCHAR(10) NOT NULL PRIMARY KEY"],
					'descripcion' => ['appgini' => "VARCHAR(100) NULL"],
				],
				'ips' => [
					'nombre' => ['appgini' => "VARCHAR(100) NOT NULL PRIMARY KEY"],
					'municipio' => ['appgini' => "VARCHAR(40) NULL"],
					'correo' => ['appgini' => "VARCHAR(40) NULL"],
					'direccion' => ['appgini' => "VARCHAR(60) NULL"],
					'telefono' => ['appgini' => "VARCHAR(40) NULL"],
					'gerente' => ['appgini' => "VARCHAR(60) NULL"],
				],
				'mails' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'idpqr' => ['appgini' => "VARCHAR(40) NULL"],
					'fecha' => ['appgini' => "VARCHAR(40) NULL"],
					'eps' => ['appgini' => "VARCHAR(40) NULL"],
					'correo' => ['appgini' => "VARCHAR(40) NULL"],
					'asunto' => ['appgini' => "VARCHAR(120) NULL"],
					'cuerpo' => ['appgini' => "LONGTEXT NULL"],
					'user' => ['appgini' => "VARCHAR(40) NULL"],
					'groupID' => ['appgini' => "INT NULL"],
				],
				'covid' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'fecha' => ['appgini' => "DATE NULL"],
					'tipodoc' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'doc' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'nombre' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'genero' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'nacimiento' => ['appgini' => "DATE NOT NULL"],
					'edad' => ['appgini' => "MEDIUMINT(3) NOT NULL"],
					'telefono' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'regimen' => ['appgini' => "VARCHAR(40) NULL"],
					'eps' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'embarazo' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'patologia' => ['appgini' => "VARCHAR(40) NULL DEFAULT '0'"],
					'fallecido' => ['appgini' => "VARCHAR(40) NULL"],
					'cual' => ['appgini' => "VARCHAR(10) NULL"],
					'atencion' => ['appgini' => "TEXT NOT NULL"],
					'tratamiento' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'medicamentos' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'vigilancia' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'percepcion' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'medicinageneral' => ['appgini' => "VARCHAR(40) NULL"],
					'oportunidad' => ['appgini' => "VARCHAR(40) NULL"],
					'observacion' => ['appgini' => "TEXT NULL"],
					'status' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'responsable' => ['appgini' => "VARCHAR(40) NULL"],
					'periodo' => ['appgini' => "VARCHAR(40) NULL"],
					'asignado' => ['appgini' => "VARCHAR(40) NULL"],
				],
				'regimenes' => [
				...
				'otros' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'fecha' => ['appgini' => "DATE NULL"],
					'asunto' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'sexo' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'tipodoc' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'procedencia' => ['appgini' => "VARCHAR(40) NULL"],
					...
					'apellidos' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'nacimiento' => ['appgini' => "DATE NOT NULL"],
					'edad' => ['appgini' => "VARCHAR(40) NULL"],
					'direccion' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'barrio' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'comuna' => ['appgini' => "VARCHAR(40) NULL"],
					'telefono' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'regimen' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'eapb' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'otraeps' => ['appgini' => "VARCHAR(40) NULL"],
					'gerente' => ['appgini' => "VARCHAR(40) NULL"],
					'poblacion' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'acudiente' => ['appgini' => "VARCHAR(40) NULL"],
					'docacu' => ['appgini' => "VARCHAR(40) NULL"],
					'nombreacu' => ['appgini' => "VARCHAR(40) NULL"],
					'descripcion' => ['appgini' => "VARCHAR(40) NULL"],
					'fechaentrega' => ['appgini' => "DATE NULL"],
					'soporte1' => ['appgini' => "VARCHAR(40) NULL"],
					'soporte2' => ['appgini' => "VARCHAR(40) NULL"],
					'soporte3' => ['appgini' => "VARCHAR(40) NULL"],
					'asignado' => ['appgini' => "VARCHAR(40) NULL"],
					'cargo' => ['appgini' => "VARCHAR(40) NULL"],
				],
				'prass' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'fecha' => ['appgini' => "DATE NULL"],
					'documento' => ['appgini' => "VARCHAR(40) NULL"],
					'nombrepaciente' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'regimen' => ['appgini' => "VARCHAR(40) NULL"],
					'eps' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'direccion' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'telefono' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'consulta' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'fechaconsulta' => ['appgini' => "DATE NULL"],
					'prueba' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'fechaprueba' => ['appgini' => "DATE NULL"],
					'estado' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'observacion' => ['appgini' => "VARCHAR(255) NULL"],
					'encargado' => ['appgini' => "VARCHAR(40) NULL"],
				],
				'oportunidad' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'tipodoc' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'doc' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'nombres' => ['appgini' => "VARCHAR(60) NOT NULL"],
					'apellidos' => ['appgini' => "VARCHAR(60) NOT NULL"],
					'regimen' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'eps' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'fechanac' => ['appgini' => "DATE NOT NULL"],
					'edad' => ['appgini' => "VARCHAR(3) NULL"],
					'atencionreq' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'fechaorden' => ['appgini' => "DATE NULL"],
					'fechacita' => ['appgini' => "DATE NULL"],
					'calificacion' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'observaciones' => ['appgini' => "TEXT NULL"],
					'asignado' => ['appgini' => "VARCHAR(40) NULL"],
				],
			];
	...
	*/
	...
	function calculated_fields() {
		...
		return array(
			'pqr' => array(
				'comuna' => 'SELECT barrios.comuna from barrios LEFT JOIN pqr ON pqr.barrio=barrios.nombre WHERE `pqr`.`id`=\'%ID%\'',
				'descripcie10' => 'select cie10.descripcion FROM `cie10` LEFT JOIN `pqr` ON `pqr`.`enfermedad`=`cie10`.`cie10` WHERE `pqr`.`id`=\'%ID%\'',
				'dias' => 'UPDATE pqr
SET    `dias` = CASE
         WHEN `condicion`=\'ABIERTA\' or `condicion` IS NULL or `condicion`="" THEN (SELECT DATEDIFF(NOW(), `fecha`))
         ELSE CONCAT("Queja Cerrada a los ", (SELECT DATEDIFF(`cierre`, `fecha`)), " dias")
       END
WHERE `pqr`.`id`=\'%ID%\'',
				'diascierre' => 'UPDATE pqr
SET    `diascierre` = CASE
         WHEN `condicion`=\'CERRADA\' THEN (SELECT DATEDIFF(`cierre`, `fecha`))
         ELSE "Queja sin cerrar"
       END
WHERE `cierre` IS NOT NULL and `pqr`.`id`=\'%ID%\'',
				'periodo' => 'UPDATE pqr
SET    `periodo` = CASE
         WHEN MONTH(`fecha`)<=3 THEN CONCAT ("1er Trimestre - ", YEAR(fecha))
         WHEN MONTH(`fecha`)<=6 AND MONTH(`fecha`)>3 THEN CONCAT ("2do Trimestre - ", YEAR(fecha))
         WHEN MONTH(`fecha`)<=9 AND MONTH(`fecha`)>6 THEN CONCAT ("3er Trimestre - ", YEAR(fecha))
         ELSE CONCAT ("4to Trimestre - ", YEAR(fecha))
       END
WHERE `pqr`.`id`=\'%ID%\'',
				'asignado' => 'select `custom1` FROM `membership_users` LEFT JOIN `membership_userrecords` ON `membership_userrecords`.`memberID`=`membership_users`.`memberID` LEFT JOIN `pqr` ON `pqr`.`id`=`membership_userrecords`.`pkValue`
WHERE `membership_userrecords`.`tableName`=\'pqr\' and `pqr`.`id`=\'%ID%\'',
				'emailuser' => 'select `email` FROM `membership_users` LEFT JOIN `membership_userrecords` ON `membership_userrecords`.`memberID`=`membership_users`.`memberID` LEFT JOIN `pqr` ON `pqr`.`id`=`membership_userrecords`.`pkValue` 
WHERE `membership_userrecords`.`tableName`=\'pqr\' and `pqr`.`id`=\'%ID%\'',
			),
			'Encuesta' => array(
				'user' => 'select `custom1` FROM `membership_users` LEFT JOIN `membership_userrecords` ON `membership_userrecords`.`memberID`=`membership_users`.`memberID` LEFT JOIN `Encuesta` ON `Encuesta`.`id`=`membership_userrecords`.`pkValue` 
WHERE `membership_userrecords`.`tableName`=\'Encuesta\' and `Encuesta`.`id`=\'%ID%\'',
			),
			'barrios' => array(
			),
			'soportes' => array(
...
SET    `periodo` = CASE
       ...
       END
WHERE `covid`.`id`=\'%ID%\'',
				'asignado' => 'select `custom1` FROM `membership_users` LEFT JOIN `membership_userrecords` ON `membership_userrecords`.`memberID`=`membership_users`.`memberID` LEFT JOIN `covid` ON `covid`.`id`=`membership_userrecords`.`pkValue` 
WHERE `membership_userrecords`.`tableName`=\'covid\' and `covid`.`id`=\'%ID%\'',
			),
			'regimenes' => array(
			),
			'otros' => array(
				'comuna' => 'SELECT barrios.comuna from barrios LEFT JOIN otros ON otros.barrio=barrios.nombre WHERE `otros`.`id`=\'%ID%\'',
				'asignado' => 'select `custom1` FROM `membership_users` LEFT JOIN `membership_userrecords` ON `membership_userrecords`.`memberID`=`membership_users`.`memberID` LEFT JOIN `otros` ON `otros`.`id`=`membership_userrecords`.`pkValue`
WHERE `membership_userrecords`.`tableName`=\'otros\' and `otros`.`id`=\'%ID%\'',
				'cargo' => 'select `custom2` FROM `membership_users` LEFT JOIN `membership_userrecords` ON `membership_userrecords`.`memberID`=`membership_users`.`memberID` LEFT JOIN `otros` ON `otros`.`id`=`membership_userrecords`.`pkValue`
WHERE `membership_userrecords`.`tableName`=\'otros\' and `otros`.`id`=\'%ID%\'',
			),
			'prass' => array(
				'encargado' => 'select `custom1` FROM `membership_users` LEFT JOIN `membership_userrecords` ON `membership_userrecords`.`memberID`=`membership_users`.`memberID` LEFT JOIN `prass` ON `prass`.`id`=`membership_userrecords`.`pkValue`
WHERE `membership_userrecords`.`tableName`=\'prass\' and `prass`.`id`=\'%ID%\'',
			),
			'oportunidad' => array(
				'asignado' => 'select `custom1` FROM `membership_users` LEFT JOIN `membership_userrecords` ON `membership_userrecords`.`memberID`=`membership_users`.`memberID` LEFT JOIN `oportunidad` ON `oportunidad`.`id`=`membership_userrecords`.`pkValue`
WHERE `membership_userrecords`.`tableName`=\'oportunidad\' and `oportunidad`.`id`=\'%ID%\'',
			),
		);
	}
	#########################################################
	...
	function lookupQuery($tn, $lookupField) {
		...
		*/
		$lookupQuery = [
			'pqr' => [
				'barrio' => 'SELECT `barrios`.`nombre`, `barrios`.`nombre` FROM `barrios` ORDER BY 2',
				'regimen' => 'SELECT `regimenes`.`nombre`, `regimenes`.`nombre` FROM `regimenes` ORDER BY 2',
				'eps' => 'SELECT `eps`.`razonsocial`, `eps`.`razonsocial` FROM `eps` LEFT JOIN `regimenes` as regimenes1 ON `regimenes1`.`nombre`=`eps`.`regimen` ORDER BY 2',
				'gerente' => 'SELECT `eps`.`razonsocial`, `eps`.`gerente` FROM `eps` LEFT JOIN `regimenes` as regimenes1 ON `regimenes1`.`nombre`=`eps`.`regimen` ORDER BY 2',
				'teleps' => 'SELECT `eps`.`razonsocial`, `eps`.`telefono` FROM `eps` LEFT JOIN `regimenes` as regimenes1 ON `regimenes1`.`nombre`=`eps`.`regimen` ORDER BY 2',
				'maileps' => 'SELECT `eps`.`razonsocial`, `eps`.`correo` FROM `eps` LEFT JOIN `regimenes` as regimenes1 ON `regimenes1`.`nombre`=`eps`.`regimen` ORDER BY 2',
				'cc2' => 'SELECT `eps`.`razonsocial`, `eps`.`correo2` FROM `eps` LEFT JOIN `regimenes` as regimenes1 ON `regimenes1`.`nombre`=`eps`.`regimen` ORDER BY 2',
				'cc3' => 'SELECT `eps`.`razonsocial`, `eps`.`correo3` FROM `eps` LEFT JOIN `regimenes` as regimenes1 ON `regimenes1`.`nombre`=`eps`.`regimen` ORDER BY 2',
				'motivo' => 'SELECT `motivos`.`motivo`, `motivos`.`motivo` FROM `motivos` ORDER BY 2',
				'obmotivo' => 'SELECT `obmotivos`.`observacion`, `obmotivos`.`observacion` FROM `obmotivos` LEFT JOIN `motivos` as motivos1 ON `motivos1`.`motivo`=`obmotivos`.`motivo` ORDER BY 2',
				'servicio' => 'SELECT `ips`.`nombre`, `ips`.`nombre` FROM `ips` ORDER BY 2',
				'enfermedad' => 'SELECT `cie10`.`cie10`, IF(CHAR_LENGTH(`cie10`.`cie10`) || CHAR_LENGTH(`cie10`.`descripcion`), CONCAT_WS(\'\', `cie10`.`cie10`, \' - \', `cie10`.`descripcion`), \'\') FROM `cie10` ORDER BY 2',
			],
			'Encuesta' => [
				'eps' => 'SELECT `eps`.`razonsocial`, `eps`.`razonsocial` FROM `eps` LEFT JOIN `regimenes` as regimenes1 ON `regimenes1`.`nombre`=`eps`.`regimen` ORDER BY 2',
				'ipsprim' => 'SELECT `ips`.`nombre`, `ips`.`nombre` FROM `ips` ORDER BY 2',
			],
			'barrios' => [
			],
			'soportes' => [
				'doc' => 'SELECT `pqr`.`id`, `pqr`.`doc` FROM `pqr` LEFT JOIN `barrios` as barrios1 ON `barrios1`.`nombre`=`pqr`.`barrio` LEFT JOIN `regimenes` as regimenes1 ON `regimenes1`.`nombre`=`pqr`.`regimen` LEFT JOIN `eps` as eps1 ON `eps1`.`razonsocial`=`pqr`.`eps` LEFT JOIN `eps` as eps2 ON `eps2`.`razonsocial`=`pqr`.`cc2` LEFT JOIN `eps` as eps3 ON `eps3`.`razonsocial`=`pqr`.`cc3` LEFT JOIN `motivos` as motivos1 ON `motivos1`.`motivo`=`pqr`.`motivo` LEFT JOIN `obmotivos` as obmotivos1 ON `obmotivos1`.`observacion`=`pqr`.`obmotivo` LEFT JOIN `ips` as ips1 ON `ips1`.`nombre`=`pqr`.`servicio` LEFT JOIN `cie10` as cie101 ON `cie101`.`cie10`=`pqr`.`enfermedad` ORDER BY 2',
			],
			'eps' => [
				'regimen' => 'SELECT `regimenes`.`nombre`, `regimenes`.`nombre` FROM `regimenes` ORDER BY 2',
			],
			...
			'covid' => [
				'regimen' => 'SELECT `regimenes`.`nombre`, `regimenes`.`nombre` FROM `regimenes` ORDER BY 2',
				'eps' => 'SELECT `eps`.`razonsocial`, `eps`.`razonsocial` FROM `eps` LEFT JOIN `regimenes` as regimenes1 ON `regimenes1`.`nombre`=`eps`.`regimen` ORDER BY 2',
				'cual' => 'SELECT `cie10`.`cie10`, IF(CHAR_LENGTH(`cie10`.`cie10`) || CHAR_LENGTH(`cie10`.`descripcion`), CONCAT_WS(\'\', `cie10`.`cie10`, \' - \', `cie10`.`descripcion`), \'\') FROM `cie10` ORDER BY 2',
			],
			'regimenes' => [
			],
			'otros' => [
				'barrio' => 'SELECT `barrios`.`nombre`, `barrios`.`nombre` FROM `barrios` ORDER BY 2',
				'regimen' => 'SELECT `regimenes`.`nombre`, `regimenes`.`nombre` FROM `regimenes` ORDER BY 2',
				'eapb' => 'SELECT `eps`.`razonsocial`, `eps`.`razonsocial` FROM `eps` LEFT JOIN `regimenes` as regimenes1 ON `regimenes1`.`nombre`=`eps`.`regimen` ORDER BY 2',
				'gerente' => 'SELECT `eps`.`razonsocial`, `eps`.`gerente` FROM `eps` LEFT JOIN `regimenes` as regimenes1 ON `regimenes1`.`nombre`=`eps`.`regimen` ORDER BY 2',
			],
			'prass' => [
				'regimen' => 'SELECT `regimenes`.`nombre`, `regimenes`.`nombre` FROM `regimenes` ORDER BY 2',
