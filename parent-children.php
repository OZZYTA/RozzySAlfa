		...
		$pcConfig = [
			...
			'soportes' => [
				'doc' => [
					...
					'tab-label' => 'Soportes <span class="hidden child-label-soportes child-field-caption">(Documento)</span>',
					'auto-close' => true,
					'table-icon' => 'resources/table_icons/file_extension_dat.png',
					'display-refresh' => true,
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => array(1 => 'Documento', 2 => 'Soporte 1', 3 => 'Soporte 2', 4 => 'Soporte 3', 5 => 'Soporte 4'),
					'display-field-names' => array(1 => 'doc', 2 => 'soporte1', 3 => 'soporte2', 4 => 'soporte3', 5 => 'soporte4'),
					'sortable-fields' => array(0 => '`soportes`.`id`', 1 => '`pqr1`.`doc`', 2 => 3, 3 => 4, 4 => 5, 5 => 6),
					'records-per-page' => 10,
					...
					'template' => 'children-soportes',
					'template-printable' => 'children-soportes-printable',
					'query' => "SELECT `soportes`.`id` as 'id', IF(    CHAR_LENGTH(`pqr1`.`doc`), CONCAT_WS('',   `pqr1`.`doc`), '') as 'doc', `soportes`.`soporte1` as 'soporte1', `soportes`.`soporte2` as 'soporte2', `soportes`.`soporte3` as 'soporte3', `soportes`.`soporte4` as 'soporte4' FROM `soportes` LEFT JOIN `pqr` as pqr1 ON `pqr1`.`id`=`soportes`.`doc` "
				],
			],
			'eps' => [
			],
